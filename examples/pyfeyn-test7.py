...
fd.add(Fermion(in_vtx, in2).addArrow().addLabel(r"\Ppositron"))
fd.add(Photon(in_vtx, out_vtx).addLabel(r"\Pphoton/\PZ"))
fd.add(Fermion(out1, out_vtx).addArrow(0.2).addLabel(r"\APquark"))
fd.add(Fermion(out_vtx, out2).addArrow(0.8).addLabel(r"\Pquark"))
glu, = fd.add(Gluon(midpoint(out_vtx, out1), midpoint(out_vtx, out2)))
